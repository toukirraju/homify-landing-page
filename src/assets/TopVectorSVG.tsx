...
const TopVectorSVG = ({
    ...
    return (
        <svg width="688" height="481" viewBox="0 0 688 481" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
